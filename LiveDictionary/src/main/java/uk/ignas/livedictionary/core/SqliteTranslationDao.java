...
public class SqliteTranslationDao implements TranslationDao {
    ...
    public SqliteTranslationDao(LabelDao labelDao, DatabaseFacade databaseFacade, AnswerDao answerDao) {
